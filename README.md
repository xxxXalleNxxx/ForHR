...
Реализация Outbox Pattern для гарантированной доставки событий между микросервисами: система бронирования столиков в ресторане, где события о создании/подтверждении/отмене броней надежно доставляются через Kafka и обрабатываются сервисом уведомлений с сохранением логов.
